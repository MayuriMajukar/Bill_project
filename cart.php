 <?php   
 session_start();  
 $connect = mysqli_connect("localhost", "root", "", "bill"); 
           ...
           <div class="container" style="width:700px;">  
                     ...
                     <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                              <!--  <img src="<?php echo $row["image"]; ?>" class="img-responsive" /><br /> -->  
                               ...
                               <input type="hidden" name="hidden_item" value="<?php echo $row["item"]; ?>" />  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          ?>  
                          <tr>  
                               <td><?php echo $values["item_item"]; ?></td>  
                               <td><?php echo $values["item_quantity"]; ?></td>  
                               <td>$ <?php echo $values["item_cost"]; ?></td>  
                               <td>$ <?php echo number_format($values["item_quantity"] * $values["item_cost"], 2); ?></td>  
                               <td><a href="cart.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
                                    $total = $total + ($values["item_quantity"] * $values["item_cost"]);  
                               }  
                          ?>  
                          <tr>  
